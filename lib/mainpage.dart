...
//
//     // 捕获截图
//     final screenshot = await Screenshot;
//     if (screenshot == null) {
...
//
//     // 显示保存成功的消息
//     ScaffoldMessenger.of(GlobalKey<ScaffoldState>().currentState!.context).showSnackBar(
...
//   }
//
//   Future<void> saveFile(String filePath, Uint8List bytes) async {
