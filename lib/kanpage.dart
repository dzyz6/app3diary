...
class Kanpage extends StatefulWidget {
  const Kanpage({Key? key, required this.token,required this.year,required this.month,required this.nowday,}) : super(key: key);
  ...
  final int month;
  @override
  State<Kanpage> createState() => _KanpageState(token:token,month:month,year:year,nowday:nowday);
}
...
class _KanpageState extends State<Kanpage> {
  ...
  int month;
  String token;
  _KanpageState({required this.token,required this.year,required this.month,required this.nowday,});
